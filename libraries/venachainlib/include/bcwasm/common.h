...
typedef const char * int128_s;
typedef const char * int256_s;
typedef const char * uint128_s;
typedef const char * uint256_s;
...
namespace bcwasm {
    ...
    using df100 = boost::multiprecision::cpp_dec_float_100;
